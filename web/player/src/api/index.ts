import { PlaybackHistory, PlaybackLyrics, PlaybackState, ResponseErr, StationInfo } from "./types";
...
class AirstationAPI {
    ...
    async getPlaybackLyrics() {
        const url = `${this.url()}/playback/lyrics`;
        return await this.makeRequest<PlaybackLyrics>(url);
    }
